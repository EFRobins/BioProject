...
def updateBurn(grid, neighbourstates, neighbourcounts):
    ...
    # array of the number of burning neighbours
    burningNeighbourCount = neighbourcounts[4]

    randomNumber = np.random.rand(200, 200)
    toBurn = generateProbability(grid, northBurning, burningNeighbourCount) > randomNumber
