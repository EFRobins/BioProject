...
def updateBurn(grid, neighbourstates, neighbourcounts):
    ...
    # TODO : Below is Hongyu's Timeline according to proportion:
    ...
    # TODO: To James: I thought the problem happened below, because your timeline is consistent, but mine is dynamic up to proportion
    ...
    # TODO : Below is Hongyu's stopBurning var:
