...
def setup(args):
    ...
    config.state_colors = [(0.7, 0.7, 0.2), (0.4, 0.8, 1), (0.3, 0.4, 0),
                           (0.9, 1, 0), (0.7, 0, 0.1), (0.4, 0.4, 0.4), (1, 0.9, 0.2), (1, 0.6, 0.1), (0, 0, 0), (0.4, 0.3, 0)]
    ...
    # Start firing on incinerator here:
    # for i in range(0, 50):
    ...
    # Start firing on power plant here:
    for i in range(0, 50):
...
def generateProbability(grid, neighbourstates, burningNeighbourCount):
    ...
    probability_9 = np.where(grid == 9, 0.003 * burningNeighbourCount, 0)
    probability_all = probability_0 + probability_2 + probability_3 + probability_9
...
# updateBurn function will be invoked in @transition_function().:
                ...
                (timeTrack == random.randint(1, 2)) & (gridray == 3)) | (
                       (timeTrack == random.randint(20, 30)) & (gridray == 0)) | (
                           (timeTrack == random.randint(20, 30)) & (gridray == 6)) | (
                                (timeTrack == random.randint(20, 30)) & (gridray == 9))
    toRed = ((timeTrack >= random.randint(250, 256)) & (gridray == 2)) | (
                (timeTrack >= random.randint(2,3 )) & (gridray == 3)) | (
                    (timeTrack >= 60) & (gridray == 0)) | ((timeTrack >= random.randint(59,60)) & (gridray == 6)) | (
                        (timeTrack >= random.randint(59,60)) & (gridray == 9))
    stopBurn = ((timeTrack >= 720) & (gridray == 2)) | ((timeTrack >= 4) & (gridray == 3)) | (
            (timeTrack >= 166) & (gridray == 0)) | ((timeTrack >= 166) & (gridray == 6))  | ((timeTrack >= 180) & (gridray == 9))
