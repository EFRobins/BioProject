...
def generateProbability(grid, diff_windDir, burningNeighbourCount):
    ...
    probability_all_NW = np.where(diff_windDir, probability_all * 1.2, probability_all)
...
def updateBurn(grid, neighbourstates, neighbourcounts):
    ...
    # Here to change the wind direction:
    ...
    # --------------------------------------------------north wind:
    diff_windDir = (N == 6) | (NW == 6) | (NE == 6)
    # --------------------------------------------------south wind:
    # diff_windDir = (S == 6) | (SW == 6) | (SE == 6)
    # --------------------------------------------------West wind:
    # diff_windDir = (W == 6) | (NW == 6) | (SW == 6)
    # --------------------------------------------------East wind:
    # diff_windDir = (E == 6) | (NE == 6) | (SE == 6)
    # --------------------------------------------------North West wind:
    # diff_windDir = (N == 6) | (NW == 6) | (W == 6)
    # --------------------------------------------------South West wind:
    # diff_windDir = (S == 6) | (SW == 6) | (W == 6)
    # --------------------------------------------------South East wind:
    # diff_windDir = (S == 6) | (ES == 6) | (E == 6)
    # --------------------------------------------------North East wind:
    # diff_windDir = (S == 6) | (ES == 6) | (E == 6)

    randomNumber = np.random.rand(200, 200)
    toBurn = generateProbability(grid, diff_windDir, neighbourcounts[6]) > randomNumber
